...
class PaytiCheck extends Cashbox implements IPrintImmediately, ICheckable, ICorrection
{
    ...
    public const CODE_CALC_VAT_122 = 'vat122';
...
if (tr_USE_OFFLINE) {
    ...
    private function mapVatValue($checkType, $vat)
    {
        $map = [
            ...
            self::CODE_VAT_22 => [
                PrepaymentCheck::getType() => self::CODE_CALC_VAT_22,
                PrepaymentReturnCheck::getType() => self::CODE_CALC_VAT_22,
                PrepaymentReturnCashCheck::getType() => self::CODE_CALC_VAT_22,
                FullPrepaymentCheck::getType() => self::CODE_CALC_VAT_22,
                FullPrepaymentReturnCheck::getType() => self::CODE_CALC_VAT_22,
                FullPrepaymentReturnCashCheck::getType() => self::CODE_CALC_VAT_22,
            ],
        ];
